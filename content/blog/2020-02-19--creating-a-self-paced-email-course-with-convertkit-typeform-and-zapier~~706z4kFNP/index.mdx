...
To accomplish this we went with the idea of a self-paced email course, which is an idea that I learned from [Brennan Dunn's in depth ConvertKit Masterclass](https://doubleyourfreelancing.com/mastering-convertkit?ref=joel).
...
[ConvertKit](https://convertkit.com?lmref=ia534A) provides powerful automations that we are able to use to produce this course and make it flow smoothly. While powerful, CK automations can also be aggravating, prone to error, hard to test, and easy to fuck up in general lol. I'm going to give a quick review of how we managed this but I highly recommend [Brennan's course](https://doubleyourfreelancing.com/mastering-convertkit?ref=joel) as it goes into much more depth.
...
If the subscriber clicks the Typeform link in the email and completes the quiz however they trigger the Zapier task which tags them as `completed` for this module and **immediate skips past the delay** to the completed event node.
...
Formatting email is tricky as well and is a constraint that we've had to deal with, but so far it works out well enough. There are complaints from a tiny fraction of folks ranging from "I don't like email" to "these are coming to fast"
...
If you want to start your own email list, I love [ConverKit](https://convertkit.com?lmref=ia534A) and the team they have built. Can't recommend them more highly.

Finally, if you want to get serious about email marketing and growing your audience with ConverKit, [Brennan Dunn's Mastering ConverKit](https://doubleyourfreelancing.com/mastering-convertkit?ref=joel) is an incredible resource that will pay for itself over and over again if you implement event a tiny fraction of his advice.
